        ...
        <table>
            ...
            <center>                
                ...
                <?php if (file_exists($urlImg)) {
                    ?>
                    <img  class="myTableStyle" style = "border-radius: 10px;width: 80px; height: 100px" src = '<?php echo $urlImg ?>'><!--Foto-->

                <?php } else { ?> 
                    <?php if ($session[5] == 'm') { ?>
                        <img class="myTableStyle"  style = "border-radius: 10px;width: 80px; height: 100px" src = '../profilePictures/profile'><!--Foto-->
                        <?php } if($session[5]=='f') { ?>
                        <img class="myTableStyle"  style = "border-radius: 10px;width: 80px; height: 100px" src = '../profilePictures/profileF'><!--Foto-->
                        <?php } ?>
                    <?php } ?>
                ...
                <tr>
                    ...
                    <td><input id="empresaTF" type="text" name="empresa" disabled="true" value="<?php
                        if ($session[7] == "")
                            echo"No tiene empresa registrada";
                        if ($session[7] != "")
                            echo $session[7]
                        ?>"></td><!--Empresa actual-->
                </tr>
